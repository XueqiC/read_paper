...
\rev{\textbf{Exact values behind Figure~\ref{fig:signif}.} Table~\ref{tab:xstest}
lists the XSTest scores shown in Figure~\ref{fig:signif}(b--c), and
Table~\ref{tab:signif} lists the differences and Welch $t$ statistics shown in
Figure~\ref{fig:signif}(a), with significance marks after Holm correction within each block and budget.}
