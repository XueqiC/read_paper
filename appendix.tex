  ...
  \begin{subtable}[t]{0.55\linewidth}
    ...
    \begin{tabular}{@{}lccc@{}}
      ...
      Task-static mix
        ...
        & $0.29{\pm}0.03$ \\
      Greedy one-step
        & $4.72{\pm}0.23$ % placeholder in the original source: replace with measured value
        & $-0.94{\pm}0.19$ % placeholder in the original source: replace with measured value
        & $0.31{\pm}0.03$ % placeholder in the original source: replace with measured value
        \\
      Grid-searched
        & $4.66{\pm}0.24$ % placeholder in the original source: replace with measured value
        & $-0.71{\pm}0.16$ % placeholder in the original source: replace with measured value
        & $0.25{\pm}0.03$ % placeholder in the original source: replace with measured value
        \\
      \textbf{ReAD}
        & $4.79{\pm}0.24$
        & $\mathbf{-0.38{\pm}0.12}$
