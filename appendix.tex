...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{figure/signif_xstest.pdf}
  \vspace{-1.2em}
  ...
  deviations (three seeds). Filled markers remain significant ($p<0.05$) after Holm
  correction within each group and budget (across all four tests for XSTest);
  safe-refusal is shown as a reduction, so positive is better everywhere.}}
  \label{fig:signif}
\end{figure}
