...
transfer beyond capability-aligned benchmarks\rev{. Appendix
Figure~\ref{fig:signif} gives a statistical view of every comparison.}
...
$150$M remain significant (Appendix Figure~\ref{fig:signif}).}
...
(Appendix Figure~\ref{fig:signif}).}
...
survives Holm correction (Appendix Figure~\ref{fig:signif}), so we read this as
