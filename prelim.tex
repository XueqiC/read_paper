...
\rev{We formalize the allocation of a fixed budget as a sequential problem; in
our experiments, the task $\tau$ is a specified target capability and $U_\tau$
is its on-target score:}
