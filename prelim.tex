...
%==================== Figure 1: empirical study (top float, replaces two wrapfigures) ====================
\begin{figure}[t]
  \centering
  \begin{minipage}[b]{0.50\linewidth}
    \centering
    \includegraphics[width=0.96\linewidth]{figure/icon.pdf}\\[1pt]
